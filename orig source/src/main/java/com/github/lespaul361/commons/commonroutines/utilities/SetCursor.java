...
public class SetCursor {
     ...
     *
     * @param component component on frame to set the cursor
     */
     ...
     * Sets the cursor to wait cursor and blocks mouse events
     *
     * @param component JFrame to set the cursor
     */
     ...
     * Sets the cursor to wait cursor and blocks mouse events
     *
     * @param component JDialog to set the cursor
     */
     ...
     * mouse events
     *
     * @param cursor integer value of cursor
     * @param component component on frame to set the cursor
     *
     *
     * <p>
     * DEFAULT_CURSOR = 0 <br>CROSSHAIR_CURSOR = 1 <br>TEXT_CURSOR = 2
     * <br>WAIT_CURSOR = 3
     * <br>SW_RESIZE_CURSOR = 4 <br>SE_RESIZE_CURSOR = 5 <br>NW_RESIZE_CURSOR =
     * 6
     * <br>NE_RESIZE_CURSOR = 7 <br>N_RESIZE_CURSOR = 8 <br>S_RESIZE_CURSOR = 9
     * <br> W_RESIZE_CURSOR = 10 <br>E_RESIZE_CURSOR = 11 <br>HAND_CURSOR = 12
     * <br>MOVE_CURSOR = 13
     */
     ...
     * @param cursor integer value of cursor
     * @param component component on frame to set the cursor
     * @param stopMouseEvents if true mouse events are stopped during the cursor
     * otherwise mouse events are allowed
     *
     * <p>
     * DEFAULT_CURSOR = 0 <br>CROSSHAIR_CURSOR = 1 <br>TEXT_CURSOR = 2
     * <br>WAIT_CURSOR = 3
