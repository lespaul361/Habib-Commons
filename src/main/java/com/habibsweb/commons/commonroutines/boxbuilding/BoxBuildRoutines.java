package com.habibsweb.commons.commonroutines.boxbuilding;
...
public class BoxBuildRoutines {
     ...
     * label
     *
     * @param leftSpace Empty space to the left of the label
     * @param labelText The text for the label
     * @param betweenSpace Space between the label and the next component
     * @param txt The component label is for
     * @param afterSpace Space of the component
     * @param txtSize size of the component
     * @param Alignment The alignment of the box
     * @return A Box with the needed components
     */
    public static Box createLabelBox(int leftSpace, String labelText, int betweenSpace, Component txt, int afterSpace, Dimension txtSize, int Alignment) {
     ...
     */
    public static Box createLabelBox(int leftSpace, String labelText, int betweenSpace, Component txt, int afterSpace, Dimension txtSize) {
     ...
     */
    public static Box createLabelBoxNoGlue(int leftSpace, String labelText, int betweenSpace, Component txt, int afterSpace, Dimension txtSize) {
        Box box = Box.createHorizontalBox();
        txt.setPreferredSize(txtSize);
        txt.setMaximumSize(txtSize);
        txt.setMinimumSize(txtSize);
     ...
     *
     * @param boxV The vertical box to add the component to
     * @param component The component to add the vertical box
     * @param topGap Space above the component being added
     */
     ...
     *
     * @param leftSpace Empty space to the left of the label
     * @param labelText1 The text for the first label
     * @param betweenSpaceLabel Space between the first label and the next
     * component
     * @param txt1 The component first label is for
     * @param betweenBoxSpace Space between the label boxes
     * @param labelText2 The text for the second label
     * @param txt2 The component second label is for
     * @param afterSpace Space of the component
     * @param txtSize size of the components
     * @return
     */
    private Box createDualLabelBoxNoGlue(int leftSpace, String labelText1, int betweenSpaceLabel, Component txt1, int betweenBoxSpace, String labelText2, Component txt2, int afterSpace, Dimension txtSize) {
     ...
     * @param spaceBetween Space between the Boxes
     * @param box2 Second Box
     * @param Alignment The alignment of the boxes within the containing box
     ...
     *
     * @param component The component to set the size on
     ...
     * @param sideGap the gap on each side
     * @return <code>Box</code>
     */
     ...
     *
     * @param btn1 Button on the left
     * @param btn2 Button on the right
     * @param szButton The side of the buttons
