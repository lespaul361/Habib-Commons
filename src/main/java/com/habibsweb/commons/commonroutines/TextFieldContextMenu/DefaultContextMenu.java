 ...
 */
package com.habibsweb.commons.commonroutines.TextFieldContextMenu;
...
public class DefaultContextMenu extends JPopupMenu {
    ...
    private void addIcon(String imageName, JMenuItem menu) {
        Image img = com.habibsweb.commonroutines.utilities.createImageFromResource.getImage("/com/habibsweb/commonroutines/TextFieldContextMenu/" + imageName, this.getClass());
