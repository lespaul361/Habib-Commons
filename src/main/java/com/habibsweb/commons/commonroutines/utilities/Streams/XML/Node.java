...
public class Node {
    ...
    private List<com.habibsweb.commons.commonroutines.utilities.Streams.XML.Attribute> attributes = new ArrayList<>();
    private String name = "";
    private String value = "";
    private List<com.habibsweb.commons.commonroutines.utilities.Streams.XML.Node> childrenNodes = new ArrayList<>();
    private int id;
    com.habibsweb.commons.commonroutines.utilities.Streams.XML.Node parentNode;
     ...
     */
    public void addAttribute(com.habibsweb.commons.commonroutines.utilities.Streams.XML.Attribute attribute) {
    ...
    public void addAttribute(String name, String value) {
        com.habibsweb.commons.commonroutines.utilities.Streams.XML.Attribute attribute = new Attribute(value, name);
        attributes.add(attribute);
    }
     ...
     */
    public void removeAttribute(com.habibsweb.commons.commonroutines.utilities.Streams.XML.Attribute attribute) {
        try {
    ...
    public void removeAttribute(String name) {
        try {
            for (com.habibsweb.commons.commonroutines.utilities.Streams.XML.Attribute attribute : attributes) {
...
class NodeEvent {
    ...
    private com.habibsweb.commons.commonroutines.utilities.Streams.XML.Node parentNode;
    private int nodeID;
